"""Fix memo tables: no box/border, spread edge-to-edge with small inset."""
...
def update_templates(apps, schema_editor):
  ...
  <section style="margin-bottom: 32px; font-size: 14px; font-family: Verdana, Geneva, sans-serif;">
    ...
    for title, html in [
        ("NPA Departmental Memorandum", dept_html),
        ("NPA Internal Memorandum", internal_html),
    ]:
...
class Migration(migrations.Migration):
    dependencies = [
        ("correspondence", "0058_update_memo_templates_standard"),
    ]
