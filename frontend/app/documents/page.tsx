    ...
    <DashboardLayout>
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="flex gap-2">
            ...
            <ContextualHelp
              ...
              description="Use tabs to switch scope, filters to narrow results, and the search bar to find specific documents."
              steps={['Switch between My Documents and Shared with Me.', 'Search matches title, reference, description, file text, and tags.', 'Use the Status and Type dropdowns to filter the list.']}
            />
          </div>
        </div>
        ...
        <HelpGuideCard
          ...
          description="Manage your documents and track items shared with you."
