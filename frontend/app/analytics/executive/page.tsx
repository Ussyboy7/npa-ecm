    ...
    <DashboardLayout>
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold">Executive Performance Dashboard</h1>
        ...
        <HelpGuideCard
          ...
          description="Monitor SLA compliance, division performance, bottlenecks, and pending escalations in real-time."
          links={[
            { label: 'SLA Configuration', href: '/admin/sla-config' },
            { label: 'Escalation Rules', href: '/admin/escalation-rules' },
          ]}
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                {slaSummary.compliant} items within SLA
              </p>
            </CardContent>
          </Card>
