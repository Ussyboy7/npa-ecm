...
const OutboxDetailPage = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to load sent item';
      setError(errorMessage);
      toast.error(`Failed to load sent item: ${errorMessage}`);
    } finally {
      setLoading(false);
    }
  ...
  const confirmWithdraw = async () => {
    ...
    try {
      ...
      await loadData();
      setTimeout(() => {
        router.push('/correspondence/my-sent');
      }, 1500);
    } catch (err: unknown) {
      ...
      {loading ? (
        <div className="p-6 flex items-center justify-center min-h-[400px]">
          <div className="text-center space-y-4">
            ...
            <p className="text-muted-foreground">Loading sent item...</p>
          </div>
        </div>
        ...
        <div className="p-6">
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <p className="text-muted-foreground mb-4">{error || 'The requested sent item could not be found.'}</p>
              <div className="flex gap-2 justify-center">
                <Button onClick={() => router.push('/correspondence/my-sent')} variant="outline">
        ...
        <div className="p-6">
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Not a Sent Item</h3>
              <p className="text-muted-foreground mb-4">
                This item is not in your sent items. It may have been dispatched or you may not have created it.
              </p>
              <div className="flex gap-2 justify-center">
                <Button onClick={() => router.push('/correspondence/my-sent')} variant="outline">
                  <ArrowLeft className="h-4 w-4 mr-2" />
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-2 md:gap-4 min-w-0 flex-1">
              <Button
                ...
                onClick={() => router.push('/correspondence/my-sent')}
              ...
              <div className="min-w-0 flex-1">
                ...
                <Breadcrumb className="hidden md:flex mb-1">
                  <BreadcrumbList>
                    <BreadcrumbItem>
                      <BreadcrumbLink href="/correspondence/my-sent">Sent</BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                      <BreadcrumbPage className="truncate max-w-[200px]">
                        {correspondence.referenceNumber || 'Sent Item'}
                      </BreadcrumbPage>
                    </BreadcrumbItem>
                  </BreadcrumbList>
                </Breadcrumb>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2 text-xs text-muted-foreground mt-0.5">
                              ...
                              {doc.role && (
                                <Badge variant={doc.role === 'primary' ? 'default' : 'secondary'} className="text-[10px] h-4 px-1">
