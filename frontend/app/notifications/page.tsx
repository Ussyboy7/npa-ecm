...
import { Check, CheckCheck, Archive, ExternalLink, Settings, Bell, Inbox, Search } from 'lucide-react';
      ...
      <div className="container mx-auto p-6 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" size="compact" onClick={() => setPreferencesOpen(true)}>
              <Settings className="h-4 w-4 mr-1.5" />
              Preferences
            </Button>
            {unreadInList > 0 && (
              <Button size="compact" onClick={handleMarkAllRead}>
        ...
        <StatStrip
          items={[
            ...
            { key: 'unread', label: 'Unread', value: unreadInList },
            { key: 'read', label: 'Read', value: readCount },
            { key: 'archived', label: 'Archived', value: archivedCount },
          ]}
        />
