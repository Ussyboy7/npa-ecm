...
import { ArrowLeft, FileText, Share2, MessageSquare, User as UserIcon, Clock, Pencil, FolderTree, X } from 'lucide-react';
...
interface DocumentHeaderProps {
  ...
  hasLinkedCorrespondence?: boolean; // Whether document is linked to correspondence
}
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 md:gap-4 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              {/* Case link - if document is linked to a case */}
              ...
              {/* Division/Department info - hidden on mobile */}
          ...
          <div className="hidden md:flex items-center gap-2 flex-shrink-0">
            ...
            <Button
              ...
              title={hasLinkedCorrespondence ? "Minute Document" : "Minute Document (only available for correspondence documents)"}
            >
